...
import com.example.benjaminlize.mylibrary.camera.CameraSourcePreview;
import com.example.benjaminlize.mylibrary.camera.GraphicOverlay;
...
public final class FaceTrackerFragment extends android.app.Fragment {
    ...
    private class GraphicFaceTracker extends Tracker<Face> {
        ...
        public void onUpdate(FaceDetector.Detections<Face> detectionResults, Face face) {
            ...
            if (smile <0.6){
                if (isTimeElapsed()){
                //TODO: schedule next alarm Go to thanks screen and
    ...
    private boolean isTimeElapsed() {
        ...
        return currentTime - mTimer < SMILE_TIME;
    }
}
