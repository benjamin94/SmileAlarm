 ...
 */
package com.example.benjaminlize.smilealarm.facedetection;
...
public final class FaceTrackerFragment extends android.app.Fragment {
    ...
    private class GraphicFaceTracker extends Tracker<Face> {
        ...
        public void onNewItem(int faceId, Face item) {
            ...
            mStartSmileTime = System.currentTimeMillis();
        }
        ...
        private long getContinuousSmileTime(Face face) {
            long now = System.currentTimeMillis();

            if (isSmiling(face)){
                long smileTime = now - mStartSmileTime;
                return smileTime;
            } else {
                mStartSmileTime = System.currentTimeMillis();
                return 0;
